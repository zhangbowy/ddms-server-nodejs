...
class SeResMgr {
    ...
    public SeasonRes: SeResModule<TableRes.SeResseason>;
    public TaskRes: SeResModule<TableRes.SeResTask>;
    public GuildRes: SeResModule<TableRes.SeResGuild>;
    public GuildAuthorityRes: SeResModule<TableRes.SeResGuildAuthority>;
    ...
    public constructor(plt: string) {
        ...
        this.SeasonRes = new SeResModule(PltFileList.get_plt_file('season.json', this._plt_));
        this.GuildAuthorityRes = new SeResModule(PltFileList.get_plt_file('GuildAuthority.json', this._plt_));
        this.GuildRes = new SeResModule(PltFileList.get_plt_file('Guild.json', this._plt_));
        this.TaskRes = new SeResModule(PltFileList.get_plt_file('Task.json', this._plt_));
        this._ready = true;
    ...
    public getGuildByLevel(level: number): TableRes.SeResGuild{
        for(var key in this.GuildRes.resData){
            if(this.GuildRes.resData[key].iLevel == level){
                return this.GuildRes.resData[key];
            }
        }
        return null;
    }
