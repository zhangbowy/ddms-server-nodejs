import { HashMap, Map } from './TeTool';
...
class ChannelMgr {
     ...
     * channel 对应的配置 逻辑服
     */
    private channelHashMap: Map<ifChannelConf> = new Map<ifChannelConf>();

    /**
     * 逻辑服对应的 channel
     */
    private ID2Channel: Map<ifChannelConf> = new Map<ifChannelConf>();
    ...
    private _parse_config() {
        // 这里建立正反向的关系,方便查询
        try {
            var t1: Map<ifChannelConf> = new Map<ifChannelConf>();
            var t2: Map<ifChannelConf> = new Map<ifChannelConf>();
